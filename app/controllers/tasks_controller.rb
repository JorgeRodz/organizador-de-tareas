class TasksController < ApplicationController
  ...
  def create
    ...
    @task.owner = current_user # current_user is a devise method
  ...
  def task_params
    params.require(:task).permit(:name, :description, :due_date, :category_id,
                                 participating_users_attributes: %i[id user_id role _destroy]) # We need it to allow ->
    #-> the creation of nested attributes
    # we need to add the "_destroy" attribute to allow the deletion of the nested attributes
  end
end
